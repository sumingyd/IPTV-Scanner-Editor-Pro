...
class UIBuilder(QtCore.QObject):
    ...
    def _setup_scan_panel(self, parent: QtWidgets.QSplitter) -> None:
        ...
        scan_layout.setContentsMargins(10, 10, 10, 10)  # 增加边距，提升美观度
        scan_layout.setSpacing(8)  # 增加间距，提升美观度
    ...
    def _setup_channel_list(self, parent) -> None:
        ...
        list_layout.setContentsMargins(10, 10, 10, 10)  # 增加边距，提升美观度
        list_layout.setSpacing(8)  # 增加间距，提升美观度
        ...
        self.main_window.channel_drag_hint_label.setStyleSheet("""
            QLabel {
                color: #4a7eff;
                font-size: 12px;
                padding: 8px 12px;
