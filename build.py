...
PYINSTALLER_CMD = [
    ...
    "--hidden-import", "controllers.epg_reminder_controller",
    ...
    "--hidden-import", "mixins",
    "--hidden-import", "mixins.server_mixin",
    "--hidden-import", "mixins.tray_mixin",
    "--hidden-import", "mixins.update_mixin",
    "--hidden-import", "mixins.thumbnail_mixin",
    "--hidden-import", "mixins.file_ops_mixin",
    "--hidden-import", "mixins.panel_mixin",
    "--hidden-import", "mixins.progress_mixin",
    "--hidden-import", "mixins.playback_mixin",
    "--hidden-import", "mixins.epg_mixin",
    "--hidden-import", "mixins.channel_mixin",
    "--hidden-import", "mixins.settings_mixin",
    "--hidden-import", "mixins.window_mixin",
    "--hidden-import", "mixins.control_panel_mixin",
    "--hidden-import", "mixins.playlist_panel_mixin",
    "--hidden-import", "mixins.event_mixin",
    "--hidden-import", "core",
    ...
    "--hidden-import", "services.batch_edit_service",
    "--hidden-import", "services.channel_classifier",
    "--hidden-import", "services.channel_cleaner",
    "--hidden-import", "services.channel_rating_service",
    "--hidden-import", "services.channel_quick_jump_service",
    "--hidden-import", "services.channel_dedup_service",
    "--hidden-import", "services.stream_quality_scorer",
    "--hidden-import", "services.epg_matcher",
    "--hidden-import", "services.epg_reminder_service",
    "--hidden-import", "services.epg_search_service",
    "--hidden-import", "services.favorites_service",
    ...
    "--hidden-import", "services.ffprobe_validator_service",
    ...
    "--hidden-import", "ui.dialogs.epg_timeline_dialog",
    ...
    "--hidden-import", "ui.dialogs.unified_search_dialog",
    "--hidden-import", "ui.dialogs.video_open_dialog",
    "--hidden-import", "ui.dialogs.global_search_dialog",
    "--hidden-import", "ui.dialogs.epg_search_dialog",
    "--hidden-import", "ui.epg_timeline_widget",
    "--hidden-import", "ui.floating_dialog",
    "--hidden-import", "ui.multi_screen_widget",
    "--hidden-import", "ui.virtual_channel_list",
    "--hidden-import", "ui.menu_proxy_style",
    "--hidden-import", "ui.cache_progress_slider",
    "--hidden-import", "ui.channel_transition_overlay",
